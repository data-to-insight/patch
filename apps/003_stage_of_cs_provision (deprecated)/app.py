...
uploaded_files = st.file_uploader(
    "Load all of your files here:", accept_multiple_files=True
)
if uploaded_files:
    loaded_files = {
    ...
    contacts = loaded_files[
        "Ofsted List 1 - Initial Contacts - with date parameters.csv"
    ]
    early_help = loaded_files[
        "Ofsted List 2 - Early Help Assessments - with date parameters.csv"
    ]
    ...
    section_47 = loaded_files[
        "Ofsted List 5 - Section 47 Enquiries - with date parameters.csv"
    ]
    child_in_need = loaded_files[
        "Ofsted List 6 - Children In Need - with date parameters.csv"
    ]
    child_protection = loaded_files[
        "Ofsted List 7 - Child Protection Plans - with date parameters.csv"
    ]
    ...
    plt.title(
        "Children with contacts who had cases opened with different stages of provision "
